// frontend/src/pages/user/CryptoMarketPage.jsx
...
function InvestModal({
  ...
  const [customROI, setCustomROI] = useState(8);
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <button
              ...
              style={{
                ...
                padding: "10px",
                borderRadius: 10,
                border: `1px solid ${planType === "fixed" ? "#f59e0b" : border}`,
                background:
                  planType === "fixed" ? "rgba(245,158,11,0.1)" : "transparent",
                color: planType === "fixed" ? "#f59e0b" : textClr,
                cursor: "pointer",
              }}
            >
              {t("fixed_plan")}
...
export default function CryptoMarketPage() {
  ...
  const fetchData = async () => {
    try {
      const [plansRes, investmentsRes, summaryRes] = await Promise.all([
        api.get("/investments/plans?market=crypto"),
        api.get("/investments/my?market=crypto"),
  ...
  const handleWithdraw = async (investmentId) => {
    try {
      ...
      showToast(t("investment_withdrawn_success"), "success");
      fetchData();
    } catch (err) {
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 20px" }}>
          ...
          >
            {loading ? (
              ...
              >
                <Bitcoin size={48} color={muted} style={{ marginBottom: 16 }} />
          ...
          {investments.length > 0 && (
            <>
              ...
              >
                {t("your_active_crypto_investments")}
              </h2>
              <div
                style={{
                  background: cardBg,
